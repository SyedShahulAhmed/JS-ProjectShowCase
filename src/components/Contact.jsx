      ...
      >
        ...
        <form onSubmit={onSubmit} className="flex flex-col justify-center px-20 gap-5 border-l-2 border-gray-700 py-5">
          <input
            ...
            id=""
            required
            className="p-2 px-5 rounded-lg text-lg bg-transparent border-2 border-[#665DDE] text-white"
          ...
          <textarea
            ...
            rows="5"
            required
            className="p-2 px-5 text-lg rounded-lg bg-transparent resize-none border-2 border-[#665DDE] text-white"
            placeholder="Enter message"
          ></textarea>
          <button
            type="submit"
            className="bg-[#665DDE] text-white w-[30%] mx-auto py-2 rounded-xl"
          >
            {result ? result : "Send"}
          </button>
        </form>
